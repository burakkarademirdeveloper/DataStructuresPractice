...
public abstract class BHeap<T> : IEnumerable<T>
        where T: IComparable
    {
        public DataStructures.Arrray.Generic.Array<T> Array { get; private set; } = new DataStructures.Arrray.Generic.Array<T>();
        ...
        {
            Count = 0;
            Array = new DataStructures.Arrray.Generic.Array<T>(_size);
            position = 0;
        }
